...
internal enum Asset {
  internal enum Main {
    internal static let arrowdown = ImageAsset(name: "Main/arrowdown")
  }
  internal enum Test {
  ...
  internal static let mailFontStrikethrough = ImageAsset(name: "mail_font_strikethrough")
  internal static let mailFontUnderline = ImageAsset(name: "mail_font_underline")
  internal static let tieba = ImageAsset(name: "tieba")
  internal static let userHeadDefault = ImageAsset(name: "user_head_default")
}
